                    ...
                    <div className="bg-gray-100 h-full">
                        <div className="m-10 bg-white h-2/3 p-10 rounded-2xl grid grid-cols-6">
                            <div className="w-64 h-80 text-center">
                                {/* <img
                                    src={`https://ap-sever.herokuapp.com/avatars/${data.user.avatar}`}
                                    alt="Avatar"
                                    className="h-full h-52 object-cover rounded-t-2xl"
                                /> */}
                                <div className="h-full h-52"></div>
                                <p className="text-xl font-bold my-5">
                                    {data.userData.fullName}
                                </p>
                                <p className="font-semibold">
                                    Mã sinh viên: {data.userData.userCode}
                                </p>
                            </div>
                            <div className="w-full pl-20 col-span-5 grid grid-cols-2 gap-10">
                                <div className="w-full">
                                    ...
                                    <List>
                                        ...
                                        <Divider />
                                        <ListItem button>
                                            Khoa: {data.userData.majorsId.name}
                                        </ListItem>
                                        <Divider />
                                        <ListItem button>
                                ...
                                <div className="w-full">
                                    ...
                                    <List>
                                        ...
                                        <Divider />
                                        <ListItem button>
                                            Địa chỉ: {data.userData.address}
                                        </ListItem>
                                        <Divider />
                                        <ListItem button>
                                            SDT: {data.userData.phone}
                                        </ListItem>
                                        <Divider />
                                    </List>
                                </div>
